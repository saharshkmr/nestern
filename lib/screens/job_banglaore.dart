...
class JobPageBangalore extends StatelessWidget {
  const JobPageBangalore({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Jobs in Bangalore'),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Subtitle
            Text(
              'Search for Bengaluru Jobs and Apply to Latest Job Vacancies in Bengaluru',
              style: TextStyle(
                fontSize: 16,
