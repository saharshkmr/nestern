...
class EmployerDetailsForm extends StatefulWidget {
  final User user;

  const EmployerDetailsForm({Key? key, required this.user}) : super(key: key);

  @override
  _EmployerDetailsFormState createState() => _EmployerDetailsFormState();
}

class _EmployerDetailsFormState extends State<EmployerDetailsForm> {
  ...
  // Add these to your _EmployerSignUpPageState
          ...
          child: Column(
            ...
            children: [
              ...
              buildDecoratedField(
                ...
                validator: (value) =>
                    value == null || value.isEmpty ? 'Enter your company website' : null,
              ),
              const SizedBox(height: 20),
              // Company Address
              buildDecoratedField(
                ...
                onSaved: (value) => companyAddress = value ?? '',
                validator: (value) =>
                    value == null || value.isEmpty ? 'Enter your company address' : null,
              ),
              ...
              DropdownButtonFormField<String>(
                ...
                onSaved: (value) => selectedIndustry = value,
                validator: (value) =>
                    value == null || value.isEmpty ? 'Select industry type' : null,
              ),
              const SizedBox(height: 20),
              DropdownButtonFormField<String>(
                ...
                onSaved: (value) => selectedCompanySize = value,
                validator: (value) =>
                    value == null || value.isEmpty ? 'Select company size' : null,
              ),
              const SizedBox(height: 20),
              // Mobile field with country code picker
              buildMobileField(),
                ...
                () async {
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    try {
                      ...
                      // Redirect to EmployerDashboard after successful save
                      if (mounted) {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => EmployerDashboard(user: updatedUser)),
                        );
                      }
                    } catch (e) {
